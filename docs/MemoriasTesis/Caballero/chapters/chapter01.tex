...
agregado. Entonces se vuelve interesante ver bajo qué condiciones la coexistencia de infraestructuras con
...
En función de esto establecemos el siguiente objetivo general.
...
\begin{quote}
    \emph{Aplicar un modelo de redes financieras a datos reales para evaluar cambios en bienestar.}
\end{quote}

El objetivo general se lleva a cabo a través de los siguientes objetivos específicos.

\subsection{Objetivos específicos}

\begin{enumerate}
    \item Evaluar la factibilidad de calibrar los primitivos del modelo de \citeA{venegas_reyes_financial_2025}, por ejemplocreencias de retorno, matrices de covarianza y coeficientes de aversión al riesgo.
